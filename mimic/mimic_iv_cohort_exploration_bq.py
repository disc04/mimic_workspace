...
from utils import data_utils, cohort_analysis_utils, cohort_plotting_utils, bq_utils
from configuration import DATA_PATH, drug_categories_dictionary
...
def analyze_services(client,
    ...
    cohort_plotting_utils.plot_services_analysis(services,
